<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="ff.ChangePassword" %>
...
<label for="OldPassword">Old Password *</label>
     <asp:TextBox runat="server" ID="Old_Password" CssClass="txt" placeholder="Enter Old Password"></asp:TextBox>
                 
<%--<input type="text" id="username">--%>
</div>
<div class="group-input">
<label for="New_Password">New Password *</label>
   <asp:TextBox runat="server" ID="New_Password" CssClass="txt" placeholder="Enter New Password"></asp:TextBox>
                  
<%--<input type="text" id="pass">--%>
</div>
	<div class="group-input">
<label for="Confirm_Password">Confirm Password *</label>
      <asp:TextBox runat="server" ID="Confirm_Password" CssClass="txt" placeholder="Enter Confirm Password"></asp:TextBox>
                       
<%--<input type="text" id="username">--%>
</div>
               <asp:Label ID="msg" runat="server" ForeColor="Red"></asp:Label>
        <asp:Button runat="server" ID="btn_pass_change" CssClass="lgnbtn" Onclick="btn_pass_change_Click" Text="Change" Font-Bold="True" Font-Size="Medium"/><br /><br />
